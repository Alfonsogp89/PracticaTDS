...
public class Pantalla2 extends JPanel{
	...
	public Pantalla2() {
		oscuro1=new ImageIcon(getClass().getResource("/oscuro-1.gif"));
		oscuro2=new ImageIcon(getClass().getResource("/oscuro-2.gif"));
		...
		boton.setIcon(new ImageIcon(getClass().getResource("/iconoboton.png")));
